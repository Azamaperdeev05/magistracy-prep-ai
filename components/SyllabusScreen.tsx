...
const SyllabusScreen: React.FC<SyllabusScreenProps> = ({ onBack }) => {
  ...
  // AI explanation state for sample items
  ...
  return (
    <div className={`min-h-screen ${bg} ${textPrimary} flex flex-col transition-colors duration-300 select-text`}>
      ...
      <UpgradeModal 
        ...
        description="КТ пәндері бойынша барлық 133 мамандықтың ресми спецификациялары мен ИИ-мұғалім түсіндірмелерін шексіз пайдалану үшін Премиум тарифіне өтіңіз."
      />
    </div>
  );
};
