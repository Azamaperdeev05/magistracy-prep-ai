...
{
  "id": "tgo-geometry-polygon-ef-length",
  "subjectId": "tgo",
  "text": "Сызбада көрсетілген көпбұрыштың EF кесіндісінің ұзындығын табыңыз.",
  "chartData": {
    "type": "tgo_polygon_ef_length"
  },
  "options": [
    {
      "id": "tgo-geometry-polygon-ef-length-a",
      "text": "4"
    },
    {
      "id": "tgo-geometry-polygon-ef-length-b",
      "text": "4√2"
    },
    {
      "id": "tgo-geometry-polygon-ef-length-c",
      "text": "5"
    },
    {
      "id": "tgo-geometry-polygon-ef-length-d",
      "text": "6"
    },
    {
      "id": "tgo-geometry-polygon-ef-length-e",
      "text": "5√2"
    }
  ],
  "correctOptionIds": [
    "tgo-geometry-polygon-ef-length-c"
  ],
  "type": "SINGLE",
  "topic": "Геометрия",
  "difficulty": "hard",
  "hint": "Шешуі:\n1. Тік бұрышты координаталар жүйесін енгізейік. А төбесін координаталар басы ретінде алайық: A(0, 0).\n2. Онда басқа нүктелердің координаталарын табамыз:\n   - G нүктесі A-дан тік жоғары 10 бірлікте орналасқан: G(0, 10)\n   - B нүктесі A-дан оңға қарай 6 бірлікте орналасқан: B(6, 0)\n   - C нүктесі B-дан тік жоғары 6 бірлікте орналасқан: C(6, 6)\n   - D нүктесі C-дан оңға қарай 4 бірлікте орналасқан: D(6 + 4, 6) = D(10, 6)\n   - E нүктесі D-дан тік жоғары 8 бірлікте орналасқан: E(10, 6 + 8) = E(10, 14)\n   - F нүктесі G-ден оңға қарай 7 бірлікте орналасқан: F(0 + 7, 10) = F(7, 10)\n\n3. F(7, 10) және E(10, 14) нүктелерінің арақашықтығын (EF кесіндісінің ұзындығын) табамыз:\n   EF = √((10 - 7)² + (14 - 10)²)\n   EF = √(3² + 4²)\n   EF = √(9 + 16) = √25 = 5.\n\nДемек, EF кесіндісінің ұзындығы 5."
}
] as Question[];
