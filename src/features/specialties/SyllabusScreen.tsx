        ...
        <aside className="w-full lg:w-80 flex flex-col gap-3 shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2.5 rounded-xl border text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-blue-500 ${isDarkMode ? 'bg-[#0f1219] border-slate-800 text-white placeholder-slate-500' : 'bg-white border-slate-200 text-slate-800 placeholder-slate-400'
                }`}
            />
          </div>
              ...
              filteredSpecialties.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left p-3 rounded-xl border transition-all text-xs flex items-center justify-between gap-3 ${isSelected
            ...
            <>
              ...
              <div className={`border-b px-6 flex items-center gap-2 overflow-x-auto scrollbar-none ${isDarkMode ? 'border-white/5 bg-slate-950/40' : 'border-slate-100 bg-slate-100/50'}`}>
                <button
                  ...
                  className={`py-3.5 px-4 text-xs font-black border-b-2 transition-all flex items-center gap-2 whitespace-nowrap ${activeTab === 'docs'
                ...
                <button
                  ...
                  className={`py-3.5 px-4 text-xs font-black border-b-2 transition-all flex items-center gap-2 whitespace-nowrap ${activeTab === 'odad'
                      ? 'border-blue-500 text-blue-500'
                      : 'border-transparent text-slate-400 hover:text-slate-600 dark:hover:text-slate-300'
                    }`}
                >
                          ...
                          >
                            ...
                            >
                              <div className="flex items-center gap-3">
                                <div className={`w-8 h-8 rounded-xl flex items-center justify-center text-xs font-black shrink-0 ${idx === 0
                                ...
                                <div>
                                  <span className={`text-[10px] font-black uppercase tracking-widest ${idx === 0 ? 'text-blue-500' : 'text-indigo-500'
                                    }`}>
                  ...
                  <div className="max-w-4xl mx-auto space-y-4">
                    <div className={`p-4 rounded-2xl border mb-6 ${isDarkMode ? 'border-blue-500/20 bg-blue-500/5' : 'border-blue-200 bg-blue-50'}`}>
                      <h3 className="text-sm font-black text-blue-600 dark:text-blue-400 flex items-center gap-2">
                        <Globe className="w-4 h-4" /> Барлық мамандыққа ортақ пәндер (Шет тілі & ОДАТ/ТГО)
                      </h3>
