              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className={`text-lg font-black uppercase tracking-tight ${textPrimary}`}>Кешенді Тестілеу</h2>
                    ...
                    {leaderboard.map((entry, idx) => {
                      ...
                      return (
                        <div key={entry.userId}
                          className={`flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors ${isSelf
                              ? (isDarkMode ? 'bg-blue-500/15 border border-blue-500/30' : 'bg-blue-50 border border-blue-200 shadow-sm')
                              : (isDarkMode ? 'hover:bg-white/5' : 'hover:bg-slate-50')
                            }`}>
                          <div className={`w-6 h-6 rounded flex items-center justify-center shrink-0 text-[9px] font-black ${idx === 0 ? 'bg-amber-500/15 text-amber-500' :
                          ...
                          <div className="text-right shrink-0">
                            <span className={`text-[11px] font-extrabold ${idx === 0 ? 'text-amber-500' :
